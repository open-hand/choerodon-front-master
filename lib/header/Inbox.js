...
var Inbox = (_dec = (0, _mobxReact.inject)('HeaderStore', 'AppState'), _dec(_class = (0, _reactOnclickoutside2['default'])(_class = (0, _mobxReact.observer)(_class = function (_Component) {
  ...
  function Inbox() {
    ...
    }, _this.handleMessageTitleClick = function (e, data) {
      // set as read && go to message detail
      _this.cleanMsg(e, data);
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { onClick: function onClick(e) {
                        return _this2.handleMessageTitleClick(e, data);
                      } },
                    title
                  )
                ),
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              'span',
              { role: 'none', style: { cursor: 'pointer' }, onClick: function onClick() {
            ...
            _react2['default'].createElement(
              'span',
              { role: 'none', style: { cursor: 'pointer' }, onClick: this.cleanAllMsg },
              '\u5168\u90E8\u6E05\u9664'
            )
          )
        ),
