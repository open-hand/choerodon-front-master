...
function asyncRouter(getComponent, getInjects, extProps, callback) {
  return function (_Component) {
    ...
    (0, _createClass3['default'])(AsyncRoute, [{
      ...
      value: function componentWillMount() {
        ...
        if (streams.length > 0) {
          _Observable.Observable.zip.apply(_Observable.Observable, streams).takeUntil(subject).subscribe(function (_ref4) {
            ...
            _this2.setState({ Cmp: Cmp, injects: injects }, function () {
      ...
      value: function render() {
        ...
        return Cmp && _react2['default'].createElement(Cmp, _extends3['default'].apply(undefined, [{}, extProps, this.props].concat((0, _toConsumableArray3['default'])(injects))));
      }
    }]);
    return AsyncRoute;
  }(_react.Component);
