...
const ENLists = () => {
  ...
  const renderSearchList = () => {
    const currentLists = filter(list, ({ data: { value, key } }) => value.toLocaleLowerCase().includes(searchValue.toLocaleLowerCase()) || searchValue.toLocaleLowerCase().includes(value.toLocaleLowerCase()));
