 ...
 *  页面级别的缓存（刷新页面即失效）
 */
const localPageCacheStore = new CacheBaseStore<string>(new LocalPageCacheStore(), { openProjectPrefix: false }) as CacheBaseStoreExtension;

export { localPageCacheStore };
