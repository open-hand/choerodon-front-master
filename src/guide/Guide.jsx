...
import asyncRouter from '../util/asyncRouteOld';
import GuidePanel from './GuidePanel';
import GuideItem from './GuideItem';
import './style';
import warning from '@choerodon/boot/lib/common/warning';
// import asyncLocaleProvider from '../../util/asyncLocaleProvider';
import asyncLocaleProvider from '@choerodon/boot/lib/containers/components/util/asyncLocaleProvider'
