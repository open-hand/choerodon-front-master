...
import { Button, Icon, Input, Modal, Select, Table, Tabs, Dropdown, Menu } from 'choerodon-ui';
...
export default class OrgSelect extends Component {
        ...
        <Menu onClick={this.handleMenuClick}>
          {
            dataSource.map((org) => (
              <Menu.Item>
                <a target="_blank" rel="noopener noreferrer" onClick={() => this.selectState(org)}>{org.name}</a>
              </Menu.Item>
            ))
          }
        </Menu>
  ...
  render() {
    ...
    const {
      AppState: { currentMenuType: { name: selectTitle = '选择组织', type, category, id, organizationId } },
