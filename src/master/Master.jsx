...
import { historyReplaceMenu } from '../util';
...
class Masters extends Component {
  ...
  initMenuType(props) {
    const { location, MenuStore, HeaderStore, history, AppState, dashboard } = props;
  ...
  render() {
    const { AutoRouter, GuideRouter, AppState } = this.props;
